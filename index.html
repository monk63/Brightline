        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Sakumono, Accra</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+233 30 341 5272</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>brightlinecompany@gmail.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            <a href="index.html" class="navbar-brand p-0">
                <h1 class="m-0"><img src="img/b.png" alt="logo" width="40" height="40"></i></i></i>rightline</h1>
            </a>
                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="Generalsupplies.html" class="dropdown-item">General Supplies</a>
                            <a href="Systemdesign.html" class="dropdown-item">System Design</a>
                            <a href="telecomsupplies.html" class="dropdown-item">Telecom Supplies</a>
                            <a href="telecominstallation.html" class="dropdown-item">Telecom Installation</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn">Construction</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase mb-3 animated slideInDown">Telecom Supplies</h5>
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn"> Telecom Supplies & Installation
                                Solution</h1>
                            <!-- <a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Free
                                Quote</a> -->
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/sys.jpg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <!-- <h5 class="text-white text-uppercase mb-3 animated slideInDown">Telecom Supplies</h5> -->
                            <h1 class="display-1 text-white mb-md-4 animated zoomIn"> System Design</h1>
                            <!-- <a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Free
                                Quote</a> -->
                            <a href="" class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Contact
                                Us</a>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="d-flex align-items-center mb-4 wow fadeIn" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4">
                            ...
                            <h4 class="text-primary mb-0">+233 30 341 5272</h4>
                        </div>
                    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Custom Telecom and Construction Solutions for Your Successful Business</h1>
            </div>
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <h4 class="mb-3">Telecom Supplies</h4>
                        <p class="m-0"
                        </p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <h4 class="mb-3">Telecom Installation</h4>
                        <p class="m-0">
                        </p>
                        <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <p class="text-white mb-3">Clita ipsum magna kasd rebum at ipsum amet dolor justo dolor est
                            magna stet eirmod</p>
                        <h2 class="text-white mb-0">+233 30 341 5272</h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Sakumono, Accra</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-envelope-open text-primary me-2"></i>
                                <p class="mb-0">brightlinecompany@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-primary me-2"></i>
                                <p class="mb-0">+233 30 341 5272</p>
                            </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Brightline</a>. All
                            Rights Reserved.

            
                            <!-- Designed by <a class="text-white border-bottom" href=" ">Rise Consult</a> -->
                        </p>
